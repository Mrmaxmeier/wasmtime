...
impl JITBuilder {
    ...
    pub fn with_isa(
        ...
        let reserve_memory_size = 2048 << 10; // reserve 2048kb (512 pages with standard 4k pages)
        Self {
            isa,
            symbols,
            lookup_symbols,
    ...
    /// TODO or disable hotswap support. See [`JITModule::prepare_for_function_redefine`]
    /// for more information.
    // TODO: rename to area?
